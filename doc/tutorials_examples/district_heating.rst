...
heating system Hamburg Wilhelmsburg [1]. The source code for this example can
be found `here <https://github.com/oemof/oemof-examples/tree/master/oemof_examples/tespy/district_heating>`_.
...
[1]: Lorenzen, P.: "Das Wärmenetz als Speicher im Smart Grid: Betriebsführung
eines Wärmenetzesin Kombination mit einem stromgeführten Heizkraftwerk". HAW
Hamburg, 2014.