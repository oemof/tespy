...
- Adapted documentation and examples in regard of new features. Examples have been moved to the `oemof-examples repository <https://github.com/oemof/oemof-examples>`_.
