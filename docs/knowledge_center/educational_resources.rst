...
.. grid:: 1 2 3 3
    ...
    .. grid-item-card::  Model thermodynamic systems with tespy
        ...
        documentation in the form of a script. The course is still under
        development and the script is not yet complete.
    ...
    .. grid-item-card::  Build component based systems at the example of a simple heat pump
        ...
        thermodynamic modeling and three different solution approaches (at the)
        example of a heat pump. These are sequential and equation based models,
        and then how to model the same system using tespy.
    ...
    .. grid-item-card::  Integrate thermodynamic models with economic dispatch assessment
        ...
        of a heat pump with a dispatch optimization problem.
