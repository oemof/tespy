...
fig.savefig(f"Sectioned_vs_Moving_pressure_drop{file_suffix}.svg", bbox_inches="tight")
...
ax.plot((heat, heat), ([T for T in T_hot], [T for T in T_cold]), color=annotation_color, linestyle="-", linewidth=0.5)
ax.plot(heat_defaultsteps, T_cold_defaultsteps, "o-", color=annotation_color, markersize=2, linewidth=0.5, label="SectionedHeatExchanger (50 sections)")
ax.plot(heat, T_hot, "o-", color="red")
ax.plot(heat, T_cold, "o-", color="blue", label="MovingBoundaryHeatExchanger")
ax.set_ylabel("temperature in K")
ax.set_xlabel("heat transferred in MW")
ax.legend()

fig.savefig(f"Sectioned_vs_Moving_pressure_drop_preheating{file_suffix}.svg", bbox_inches="tight")
