...
- Redesigned pre- and postprocessing of component properties as some errors occurred before. Design parameters are now always gathered from the component .csv-file containing the design point information (saved design state of the network) (`PR #50 <https://github.com/oemof/tespy/pull/50>`_).
