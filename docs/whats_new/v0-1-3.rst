...
- Implement warning messages for all components, if the component's properties are out of physical bounds. The bounds can be customized when specifying a property
  by data containers (read more at :ref:`component parameter specification <modules_components_parametrisation_label>`), (`PR #85 <https://github.com/oemof/tespy/pull/85>`_).
...
- Improve documentation of the functions :code:`tespy.components.components.component.zeta_func` and :code:`tespy.components.components.component.zeta2_func`
