...
- The subsystem architecture has been simplified. Your connections and components are saved to dictionaries to make
  ...
  case of subsystems, have a look at the :ref:`district heating example <tutorial_district_heating_label>`.
...
- Move the default characteristic function plots to the :ref:`data_label` documentation
