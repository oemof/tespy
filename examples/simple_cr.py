...
# main cycle
fs = con.connection(source, 'out1', turbine, 'in1',
                    p=100, T=500, m=100, fluid={'water': 1})
...
fs_out = con.connection(steam_generator, 'out1', sink, 'in1',
                        p=con.ref(fs, 1, 0), h=con.ref(fs, 1, 0))
nw.add_conns(fs, ws, cond, fw, fs_out)

# cooling water
cw_in = con.connection(source_cw, 'out1', condenser, 'in2',
                       T=20, p=5, fluid={'water': 1})
