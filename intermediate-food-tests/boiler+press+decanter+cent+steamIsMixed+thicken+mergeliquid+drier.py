...
drier            = Separator('drier',num_out=2)
meal             = Sink('meal')
...
c11 = Connection(thickener, 'out1', vapourextract1, 'in1')
c12 = Connection(thickener, 'out2', valvemerge3, 'in1')
c12o = Connection(valvemerge3, 'out1', liquidmerge, 'in3')
c13 = Connection(liquidmerge, 'out1', drier, 'in1')
c14 = Connection(drier, 'out1', meal, 'in1')
c15 = Connection(drier, 'out2', vapourextract2, 'in1')

network.add_conns(c1,c2,c3,c4,c5,c6,c6_1,c6_2,c7,c7o,c8,c9,c10,c11,c12,c12o,c13,c14,c15)
...
c15.set_attr(fluid={'FoodWater': 1, 'FoodFat': 0, 'FoodProtein': 0})
c14.set_attr(fluid={'FoodWater': 0.08})
c14.set_attr(h0=1e2,p0=1,fluid0={'FoodWater': 0.33, 'FoodFat': 0.33, 'FoodProtein': 0.33})
c15.set_attr(h0=1e2,p0=1,fluid0={'FoodWater': 0.33, 'FoodFat': 0.33, 'FoodProtein': 0.33})

for c in network.conns['object']:
    c.set_attr(m0=total_flow_in,h0=1e2,p0=1,fluid0={'FoodWater': 0.33, 'FoodFat': 0.33, 'FoodProtein': 0.33})
