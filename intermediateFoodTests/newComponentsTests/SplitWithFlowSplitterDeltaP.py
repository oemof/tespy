...
from tespy.components.newcomponents import DiabaticSimpleHeatExchanger,MergeWithPressureLoss,SeparatorWithSpeciesSplits,SplitWithFlowSplitter,SplitWithFlowSplitterDeltaP
...
so = Source("Source")
se = SplitWithFlowSplitterDeltaP("Splitter",num_out=2)
si1 = Sink("Sink 1")
si2 = Sink("Sink 2")
