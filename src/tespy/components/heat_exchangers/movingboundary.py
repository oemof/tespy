...
class MovingBoundaryHeatExchanger(HeatExchanger):
    ...
    def calc_UA_in_sections(self):
        ...
        if i1.h.val_SI > h_sat_gas and o1.h.val_SI < h_sat_liquid:
            h_at_steps_1 = [i1.h.val_SI, h_sat_gas, h_sat_liquid, o1.h.val_SI]
            sections = 3

        elif ((i1.h.val_SI > h_sat_gas) ^ (o1.h.val_SI < h_sat_liquid)):
            sections = 2
            if i1.h.val_SI > h_sat_gas:
