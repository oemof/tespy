...
COMP_TARGET_CLASSES = {
    ...
    'Pump': Pump,
    'Turbine': Turbine,
    'MergeWithPressureLoss' :MergeDeltaP,
    'SeparatorWithSpeciesSplits' : SeparatorWithSpeciesSplits,
    'SeparatorWithSpeciesSplitsAndDeltaT' : SeparatorWithSpeciesSplitsDeltaT,
    'SeparatorWithSpeciesSplitsAndDeltaTAndPr' : SeparatorWithSpeciesSplitsDeltaTDeltaP,
    'SeparatorWithSpeciesSplitsAndPr' : SeparatorWithSpeciesSplitsDeltaP,
