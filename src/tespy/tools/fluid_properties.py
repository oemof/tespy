    ...
    def add_fluids(fluids, memorise_fluid_properties=True):
        ...
        if Memorise.thermosteam['use'] == True:
            ...
            if 'H2O' and "KOH" in fluids.keys():
                ...
                Memorise.thermosteam['CASs_no_water'] = list(chemicals.CASs[Memorise.thermosteam['H2O_index'] + 1:Memorise.thermosteam['KOH_index'] + 1])
            ...
            for f, back_end in fluids.items():
                if f not in Memorise.state and back_end != 'TESPy':
                    ...
                    # print(molar_masses[f])
                    # print(gas_constants[f])
                    # print(gas_constants['uni'])
...
def h_mix_pT(flow, T, force_gas=False):
    ...
    if Memorise.thermosteam['use']==True:
        ...
        # print("specific enthalpy from thermosteam:", val)
        return val
    ...
    # print("specific enthalpy from coolprop:", h)
    return h
...
def v_mix_pT(flow, T):
    ...
    if Memorise.thermosteam['use']==True:
        ...
        # Memorise.thermosteam['stream'].show(flow="kg/s")
        ...
        # print("specific volume from thermosteam:", val)
        return val
    ...
    print("specific volume from coolprop:", 1 / d)
    return 1 / d
...
def visc_mix_pT(flow, T):
    ...
    if Memorise.thermosteam['use']==True:
        ...
        # print("viscosity from thermosteam:", val)
        return val
    ...
    print("viscosity from coolprop:", a / b)
    return a / b
...
def s_mix_pT(flow, T, force_gas=False):
    ...
    if Memorise.thermosteam['use']==True:
        ...
        # print("specific entropy from thermosteam:", val)
        return val
    ...
    print("specific entropy from coolprop:", s)
    return s
...
"""added functions for thermosteam implementation"""
