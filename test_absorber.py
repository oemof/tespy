...
#
#  in1: water
#  in2: wasser/LiBr Lösung mit geringem Wasseranteil bzw. Mischung aus Lösung und Wasserdampf
#  out1: gesättigte LiBr Lösung
#  m_in1 + m_in2 = m_out1
#  m_in1 * x_water,in1 + m_in2 * x_water,in2 =  m_out1 * x_water,out1
#  x_libr,out1 = x(p_out1, T_out1, voll gesättigt) p_sat(x, T_sat) berechnen
#  x_water,out1 = 1 - x_libr,out1
#  p_in1 = p_out1
#  p_in2 = p_out2
#
    # watercycle
