...
class TestPolynomialCompressor:
    ...
    def test_eta_s(self):
        ...
        instance.set_attr(eta_s=0.8, Q_diss_rel=0.1)
    ...
    def test_eta_vol(self, reference_state):
        ...
        instance.set_attr(eta_vol=0.8, rpm=1500, reference_state=reference_state)
        self.nw.solve('design')
        self.nw.assert_convergence()
    ...
    def test_eta_vol_var_rpm(self, reference_state):
        ...
        self.c2.set_attr(p=6, T=150)
        instance.set_attr(eta_vol=0.8, rpm="var", reference_state=reference_state)
        self.nw.solve('design')
        self.nw.assert_convergence()
    ...
    def test_eta_poly(self, power_data, cooling_data, reference_state):
        ...
        instance.set_attr(
            ...
            eta_s_poly=eta_s_poly, Q_diss_rel=0,
