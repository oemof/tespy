...
turb_2_valv = Connection(turb, 'out1', si, 'in1', label="Outlet")

nw.add_conns(so_2_compr, compr_2_turb, turb_2_valv)
...
exe_eco_input = {'Source_c': 10, 'Turbine_Z': 50, 'Compressor_Z': 40}
