...
nw = Network()
nw.units.set_defaults(temperature="degC", pressure="bar", enthalpy="kJ/kg", heat="kW", power="kW")
...
# %%[sec_2]
cons.set_attr(Q=-10, pr=0.98)
hs.set_attr(pr=1)
pu.set_attr(eta_s=0.75)
pipe_feed.set_attr(Q=-0.250, pr=0.98)
pipe_return.set_attr(Q=-0.200, pr=0.98)
...
ax[3].set_ylabel('Heat losses in kW')
